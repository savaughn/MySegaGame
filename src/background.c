...
void updateScrolling() {
    ...
    scroll_b_x -= (player_scroll_delta_x / PARALLAX_FACTOR_BG_A); // Or use PARALLAX_FACTOR_BG_B as per defines
    scroll_b_y += (player_scroll_delta_y / PARALLAX_FACTOR_BG_A); // Assuming A is near, B is far from defines
