...
SAMPLE_RATE = 13300  # Hz (CD quality is 44100, lower saves space)
...
RUMBLE_START_FREQ = 200 # Hz - Initial impact/crack sound
RUMBLE_END_FREQ = 60    # Hz - Lingering low rumble
RUMBLE_MIX = 0.8        # How much of the rumble component is present (0.0 to 1.0)

# Noise component (for the chaotic/hissing part)
NOISE_MIX = 0.8         # How much of the noise component is present (0.0 to 1.0)
